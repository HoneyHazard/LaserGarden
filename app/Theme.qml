...
QtObject {
    ...
    property color tooltipBackgroundColor: "black" // Off-white text
    property color tooltipTextColor: "yellow"  // Dark blue text
    ...
    property color mainBeamColorB: "cyan"  // Magenta for beam B
